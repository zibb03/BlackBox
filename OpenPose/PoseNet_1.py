...
'''
path = 'C:/Users/user/Documents/GitHub/blackbox/data/wrist1.JPG'
#path = 'C:/Users/user/Documents/GitHub/blackbox/data/dog.png'
    ...
    for pair in POSE_PAIRS:
        ...
        if points[part_a] and points[part_b]:
            ...
            # RElbow 과 RWrist 의 좌표값이 존재한다면
                ...
                if (points[3] is not None) and (points[4] is not None):
                    a = calculate_degree1(point_1=points[3], point_2=points[4], frame=frame_line)
                    if a > 45:
                        cv2.line(frame, points[3], points[4], (0, 0, 255), 3)
                    else:  # 노란색 선
            ...
            # LElbow 과 LWrist 의 좌표값이 존재한다면
                ...
                if (points[6] is not None) and (points[7] is not None):
                    a = calculate_degree2(point_1=points[6], point_2=points[7], frame=frame_line)
                    if a > 45:
                        cv2.line(frame, points[6], points[7], (0, 0, 255), 3)
                    else:  # 노란색 선
...
def calculate_degree2(point_1, point_2, frame):
    ...
    # if deg < 45:
    #     cv2.line(frame, points[6], points[7], (255, 0, 0), 3)
    # else:  # 노란색 선
    #     cv2.line(frame, points[6], points[7], (0, 255, 0), 3)
