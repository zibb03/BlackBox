...
def output_keypoints(image, threshold, BODY_PARTS):
    global points
...
def video_processing(video_path, background):
    ...
    while cap.isOpened():
        ...
        frame_man = output_keypoints(image=result_image, threshold=0.1, BODY_PARTS=BODY_PARTS_BODY_25)
